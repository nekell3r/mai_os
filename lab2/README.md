...
├── rebuild.ps1                 # Скрипт автоматической пересборки
...
Проект использует CMake и Ninja для сборки.
...
Подробные инструкции см. в файле [BUILD.md](BUILD.md)
...
- Обнаруживает исполняемый файл (для Ninja или Visual Studio сборки)
